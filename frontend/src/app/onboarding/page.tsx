...
import { GraduationCap, Briefcase, Calendar, MapPin, DollarSign, Shield, ArrowRight, ArrowLeft, Sparkles } from 'lucide-react';

const steps = ['Role', 'Details', 'Preferences', 'Safety'];
          ...
          {step === 1 && (
            <div className="flex flex-col gap-5">
              ...
              <div>
                ...
                <input className="input-field" placeholder="e.g., April 2024" value={form.moveMonth} onChange={(e) => update('moveMonth', e.target.value)} />
              </div>
              <div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div>
                <label className="block text-sm font-medium mb-3" style={{ color: 'var(--text-secondary)' }}>
                  <DollarSign size={14} className="inline mr-1" /> Monthly Budget Range
                </label>
